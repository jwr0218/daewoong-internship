...
class TextRank(object):
    def __init__(self, text):
        ...
        if text[:5] in ('http:', 'https'):
            ...
            # text 값 받으려면 text2sentence 를 하여서 모델 돌리면 됨
...
H = Hannanum()
twttierMS = np.array(Image.open('C:/Users/User/Desktop/DSHo3ZtUIAEdprV.png'))

    
a = " ".join(H.nouns(" ".join(textrank.summarize(10))))
wc = WordCloud(font_path = "C:/Users/User/Desktop/BMEULJIROTTF.ttf"
...
#에초에 이걸 저장하는 구간이 얼마 안되어서 리턴시키는 값들이 올바른지도 잘 모르겠음
